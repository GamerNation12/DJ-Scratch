...
async def setup_hook():
    ...
    if db_url:
        try:
            ...
            cogs = ['cogs.admin', 'src.commands.admin_ipc', 'src.commands.lastfm', 'src.commands.importer', 'src.commands.settings', 'src.commands.info', 'src.commands.spotify_remote', 'src.commands.social']
            for cog in cogs:
                try:
