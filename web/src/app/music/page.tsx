...
export default function MusicDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0e0618] text-white pt-20 px-4 sm:px-6 lg:px-8 pb-10">
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        {error ? (
          ...
          <div className="animate-pulse flex gap-6 p-6 bg-[#170b28]/50 rounded-2xl border border-white/5">
          ...
          <div className="bg-[#170b28]/50 border border-white/5 p-10 rounded-2xl text-center text-zinc-400">
          ...
          <div className="bg-[#170b28]/80 backdrop-blur-xl border border-white/10 p-6 sm:p-10 rounded-3xl shadow-2xl flex flex-col sm:flex-row gap-8 items-center sm:items-start relative overflow-hidden group">
            {/* Background Blur */}
            ...
            <div className="flex-1 flex flex-col justify-center z-10 w-full">
              <h2 className="text-3xl sm:text-5xl font-display font-black text-white tracking-tight mb-2 line-clamp-2">{nowPlaying.song}</h2>
