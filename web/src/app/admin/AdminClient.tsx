    ...
    <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-2xl p-6 shadow-lg">
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <button onClick={() => { setContent(prev => prev + "🚀 **Major Update:** "); setIsManualVersion(false); }} className="text-xs bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 px-2 py-1 rounded hover:bg-indigo-500/30 transition-colors">🚀 Major Update</button>
        </div>
